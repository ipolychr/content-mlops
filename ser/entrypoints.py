...
from ser.feature_extraction.feature_extraction import FeatureExtraction
from ser.preprocessor.audio_preprocess import AudioPreprocess
from ser.preprocessor.factories import get_dataset, get_audio_preprocessor
from ser.trainer.optimizer import Optimizer
from ser.utils.metadata import extract_audio_metadata
from ser.utils.model_selection import model_selection
from ser.utils.save_load import save_model
from ser.utils.save_mel_spec_img import save_mel_spec_per_genre
...
def train_tl_model_images(tl_model: TLModel, criterion: Criterion, optimizer: Optimizer,
    ...
    @param save: if true save the ser_checkpoints to desired path
