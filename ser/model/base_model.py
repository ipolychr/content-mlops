...
from ser.data_model.evaluation import EvaluationMetrics
from ser.trainer.optimizer import Optimizer, OptimizerBase
...
class TLModelBase(ABC):
    ...
    def __init__(self,
        ...
        self.genre_dict = {"angry": 0, "disgust": 1, "fear": 2, "happy": 3, "neutral": 4, "sad": 5, "surprise": 6}
